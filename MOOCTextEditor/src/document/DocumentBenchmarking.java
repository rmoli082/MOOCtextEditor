	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			 ...
			 */  
			 ...
			 String docText = getStringFromFile(textfile, numToCheck);
			 
			 startTime = System.nanoTime();
			 for (int i = 0; i <= trials; i++) {
				 BasicDocument bdDoc = new BasicDocument(docText);
				 bdDoc.getFleschScore();
			 }
			 ...
			 startTime = System.nanoTime();
			 for (int i = 0; i <= trials; i++) {
				 EfficientDocument edDoc = new EfficientDocument(docText);
				 edDoc.getFleschScore();
			 }
			 endTime = System.nanoTime();
			 runTime = (endTime - startTime) / 1000000000.0;
			 System.out.print(runTime + "\n");
